...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_ortho_4x12 (
        ...
        KC_LCTL, KC_PGUP, KC_PGDN, KC_LALT, MO(1), LT_NUM, KC_SPC, MO(2), MO(3),   KC_LBRC, KC_RBRC, KC_QUOT
    ),
    ...
    [2] = LAYOUT_ortho_4x12 (
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, KC_DLR,  KC_PERC, KC_CIRC, KC_UNDS,
        _______, _______, _______, _______, _______, _______, _______, _______, KC_EXLM, KC_AT,   KC_HASH, KC_PLUS,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ), 
