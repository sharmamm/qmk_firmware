...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_planck_mit (
        ...
        KC_LCTL, KC_PGUP, KC_PGDN, KC_LALT, MO(1),    KC_SPC   ,   MO(2), MO(3),   KC_LBRC, KC_RBRC, KC_QUOT
    ),
    ...
    [2] = LAYOUT_planck_mit (
        ...
        _______, _______, _______, _______, _______,     _______,      _______,  _______, _______, _______, RGB_VAI
    ),
    ...
    [3] = LAYOUT_planck_mit (
        ...
        _______, _______, _______, _______, _______,       _______,      _______,  _______, RGB_SPD, RGB_SPI, RESET
    ) 
};
