...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* Layer 1
     * ,-----------------------------------------------------------------------------------.
     * |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |      |UCMAIL|  (   |  )   |  _   |  +   |
     * |------+------+------+------+------+-------------+------+------+------+------+------|
     * | LGUI |      | Prev | Play | Next |GMAIL1|HLIGHT|      |  %   |  ^   |  &   |  *   |
     * |------+------+------+------+------+------|------+------+------+------+------+------|
     * |      |      | Vol- | Mute | Vol+ |      |      |      |  !   |  @   |  #   |  $   |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |      |      |      |      |      |      |      |      |      |      |      |      |
    ...
    [1] = LAYOUT_ortho_4x12(
        ...
        KC_LGUI, _______, KC_MPRV, KC_MPLY, KC_MNXT, GMAIL1,  HLIGHT,  _______, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR,
    ...
    /* Layer 3 
     * ,-----------------------------------------------------------------------------------.
     * |  ~   | RGB  |Mode- |Mode+ | Hue- | Hue+ |      |      |  9   |  0   |  -   |  =   |
     * |------+------+------+------+------+-------------+------+------+------+------+------|
     * |      | Sat- | Sat+ |Brite-|Brite+|Plain |      |      |  5   |  6   |  7   |  8   |
     * |------+------+------+------+------+------|------+------+------+------+------+------|
     * |      |Breath|Rainbo|Swirl |Snake |Grad  |      |      |  1   |  2   |  3   |  4   |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |      |      |      |      |      |      |      |      |      |Speed-|Speed+|Reset |
     * `-----------------------------------------------------------------------------------'
     */
    ...
    /* Layer 4 
     * ,-----------------------------------------------------------------------------------.
     * |      |      |SShot1|      |      |      |      |      | OS+9 |W_Prev|M_Ctrl|W_Next|
     * |------+------+------+------+------+-------------+------+------+------+------+------|
     * |      |      |SShot2|      |      |      |      |      | OS+4 | OS+5 | OS+6 | OS+8 |
     * |------+------+------+------+------+------|------+------+------+------+------+------|
     * |      |      |      |      |      |      |      |      | OS+1 | OS+2 | OS+3 | OS+4 |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |      |      |      |      |      |      |      |      |      |      |      |      |
    ...
    [4] = LAYOUT_ortho_4x12(
        ...
        _______, _______, SSHOT2,  _______, _______, _______, _______, _______, SUPER_5, SUPER_6, SUPER_7, SUPER_8,
