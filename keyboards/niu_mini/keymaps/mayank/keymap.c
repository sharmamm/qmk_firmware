...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |------+------+------+------+------+-------------+------+------+------+------+------|
     * |      |      |SShot1|      |      |GMAIL2| Left | Down |  Up  |Right |      |      |
     * |------+------+------+------+------+------|------+------+------+------+------+------|
    ...
    [2] = LAYOUT_ortho_4x12(
        ...
        _______, _______, SSHOT1,  _______, _______, GMAIL2,  KC_LEFT, KC_DOWN,  KC_UP,   KC_RGHT, _______, _______,
    ...
    [4] = LAYOUT_ortho_4x12(
        ...
        _______, _______, SSHOT2,  _______, _______, _______, _______, _______, SUPER_4, SUPER_5, SUPER_6, _______,
